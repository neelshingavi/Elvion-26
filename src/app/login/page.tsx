        ...
        >
            ...
            {error && (
              ...
              >
                ...
                <button
                  ...
                  className="ml-auto hover:text-foreground p-1"
                >
                  <X className="w-4 h-4" />
                </button>
              </motion.div>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-app px-2 text-muted">
                Or continue with
              </span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={loading || !isConfigValid}
            className="w-full flex items-center justify-center gap-3 bg-surface border border-subtle hover:bg-surface-alt px-8 py-3 rounded-xl font-semibold transition-all disabled:opacity-50"
          >
