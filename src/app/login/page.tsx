...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-black/95 p-4 md:p-6 lg:p-8">
            <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }}
                className="w-full max-w-5xl grid lg:grid-cols-2 bg-neutral-900 rounded-3xl overflow-hidden shadow-2xl border border-white/5"
            >
                {/* Left Panel - Image */}
                <div className="hidden lg:block relative h-full min-h-[600px] bg-neutral-800">
                    <Image
                        src="/auth-image.jpg"
                ...
                <div className="flex items-center justify-center p-8 md:p-12 relative bg-neutral-900">
                                ...
                                {mode === 'signup' && (
                                    ...
                                    >
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-black/50 border border-neutral-800 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-indigo-500 transition-colors placeholder:text-neutral-600"
                                        />
                                    </motion.div>
                                )}
                            </AnimatePresence>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full bg-black/50 border border-neutral-800 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-indigo-500 transition-colors placeholder:text-neutral-600 pr-10"
                                    />
                                    <button
                                        type="button"
