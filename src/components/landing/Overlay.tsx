        ...
        <div className="absolute top-0 left-0 w-full z-10 pointer-events-none">
            ...
            <Section>
                ...
                >
                    ...
                    <div className="flex gap-4 justify-center">
                        <Link
                            href="/login"
                            className="bg-indigo-600 hover:bg-indigo-500 text-white px-8 py-3 rounded-full font-bold transition-all text-lg flex items-center gap-2"
                        >
                            Start Building <ArrowRight className="w-5 h-5" />
                        </Link>
                    </div>
                    <div className="mt-12 animate-bounce">
                        <p className="text-sm text-zinc-500">Scroll to Explore</p>
                    </div>
                </motion.div>
            </Section>
            ...
            <Section className="items-start text-left">
                <motion.div
                    ...
                    className="max-w-xl pointer-events-auto bg-black/30 backdrop-blur-md p-8 rounded-2xl border border-white/10"
                >
            ...
            <Section className="items-end text-right">
                ...
                >
                    ...
                    <ul className="space-y-3 text-zinc-400 justify-end">
            ...
            <Section>
                <motion.div
                    ...
                    transition={{ duration: 0.8 }}
                    className="text-center pointer-events-auto bg-gradient-to-br from-indigo-900/80 to-purple-900/80 backdrop-blur-lg p-12 rounded-3xl border border-white/20"
                >
                    <h2 className="text-5xl font-black mb-6">Ready to Launch?</h2>
                    <p className="text-xl text-zinc-200 mb-8 max-w-lg mx-auto">
                        Join thousands of founders who turned their spark into a flame with FounderFlow.
                    </p>
                    <Link
                        href="/login"
                        className="bg-white text-indigo-900 hover:bg-zinc-200 px-10 py-4 rounded-full font-black transition-all text-xl inline-flex items-center gap-2"
                    >
